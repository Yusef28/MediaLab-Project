* This file may be used to read the data in 'C:\MediaLab\Samples\simplyauthority\data\byquestionnaire\myTextBox.txt'.
...
* C:\MediaLab\Samples\simplyauthority\data\byquestionnaire\myTextBox (by variable).sps.
*. 
...
data list file 'C:\MediaLab\Samples\simplyauthority\data\byquestionnaire\myTextBox.txt' free
   /Subject (A25)       Cond (A25)          Exper (A50)         Inifile (A25)
    Date (A25)          Time (A25)
    que1 (A25) 
    instcon1 (A50)      inst2con1 (A50)     urppcon1 (A50)      instr3con1 (A50) 
    practicecon1 (A50)  inst4con1 (A50)     text1con1 (A50)     selfrating1con1_01 (A50) 
    selfrating1con1_02 (A50) 
                        feed1con1 (A50)     waitcon1 (A50)      next1con1 (A50) 
    text2con1 (A50)     selfrating2con1_01 (A50) 
                                            selfrating2con1_02 (A50) 
                                                                feed2con1 (A50) 
    wait2con1 (A50)     next2con1 (A50)     text3con1 (A50)     selfrating3con1_01 (A50) 
    selfrating3con1_02 (A50) 
                        feed3con1 (A50)     wait3con1 (A50)     qualcon1 (A50) 
    endcon1 (A50) 
    tinstcon1 *         tinst2con1 *        tselfrating2con1_01 * 
                                                                tselfrating2con1_02 * 
    que2 (A25) 
    instcon2 (A50)      inst2con2 (A50)     urppcon2 (A50)      instr3con2 (A50) 
    practicecon2 (A50)  inst4con2 (A50)     text1con2 (A50)     selfrating1con2_01 (A50) 
    selfrating1con2_02 (A50) 
                        feed1con2 (A50)     waitcon2 (A50)      next1con2 (A50) 
    text2con2 (A50)     selfrating2con2_01 (A50) 
                                            selfrating2con2_02 (A50) 
                                                                feed2con2 (A50) 
    wait2con2 (A50)     next2con2 (A50)     text3con2 (A50)     selfrating3con2_01 (A50) 
    selfrating3con2_02 (A50) 
                        feed3con2 (A50)     wait3con2 (A50)     qualcon2 (A50) 
    endcon2 (A50) 
    tinstcon2 *         tinst2con2 *        tselfrating2con2_01 * 
                                                                tselfrating2con2_02 * 
    que3 (A25) 
    instcon3 (A50)      inst2con3 (A50)     urppcon3 (A50)      instr3con3 (A50) 
    practicecon3 (A50)  inst4con3 (A50)     text1con3 (A50)     selfrating1con3_01 (A50) 
    selfrating1con3_02 (A50) 
                        feed1con3 (A50)     waitcon3 (A50)      next1con3 (A50) 
    text2con3 (A50)     selfrating2con3_01 (A50) 
                                            selfrating2con3_02 (A50) 
                                                                feed2con3 (A50) 
    wait2con3 (A50)     next2con3 (A50)     text3con3 (A50)     selfrating3con3_01 (A50) 
    selfrating3con3_02 (A50) 
                        feed3con3 (A50)     wait3con3 (A50)     qualcon3 (A50) 
    endcon3 (A50) 
    tinstcon3 *         tinst2con3 *        tselfrating2con3_01 * 
                                                                tselfrating2con3_02 * 
    que4 (A25) 
    instcon4 (A50)      inst2con4 (A50)     urppcon4 (A50)      instr3con4 (A50) 
    practicecon4 (A50)  inst4con4 (A50)     text1con4 (A50)     selfrating1con4_01 (A50) 
    selfrating1con4_02 (A50) 
                        feed1con4 (A50)     waitcon4 (A50)      next1con4 (A50) 
    text2con4 (A50)     selfrating2con4_01 (A50) 
                                            selfrating2con4_02 (A50) 
                                                                feed2con4 (A50) 
    wait2con4 (A50)     next2con4 (A50)     text3con4 (A50)     selfrating3con4_01 (A50) 
    selfrating3con4_02 (A50) 
                        feed3con4 (A50)     wait3con4 (A50)     qualcon4 (A50) 
    endcon4 (A50) 
    tinstcon4 *         tinst2con4 *        tselfrating2con4_01 * 
                                                                tselfrating2con4_02 * .
